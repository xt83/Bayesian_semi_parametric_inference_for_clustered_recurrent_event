...
save(mcmc_samples,betad, betad_true,betar, betar_true,sigma,sigma_true,y,y_true,y_index,eta,eta_true,tao,zeta,file = paste0("n_combn_sim_06_all_",n,"_", seed,"_partly_overlap_strong_all_logistic_larger_variance_f3", ".rdata")) 
